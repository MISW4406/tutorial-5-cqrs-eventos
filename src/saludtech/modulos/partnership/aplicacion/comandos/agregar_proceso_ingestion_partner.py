...
from saludtech.modulos.partnership.infraestructura.repositorios import RepositorioProcesoIngestionPartnerPg
...
class AgregarProcesoIngestionPartner(Comando):
    id_partner: uuid.UUID
    id_proceso_ingestion: uuid.UUID
    fecha_creacion: str
...
class AgregarProcesoIngestionPartnerHandler(AgregarProcesoIngestionPartnerBaseHandler):
    def handle(self, comando: AgregarProcesoIngestionPartner):
        ...
        proceso_ingestion_partner: ProcesoIngestionPartner = self.fabrica_ingestion.crear_objeto(proceso_ingestion_partner_dto, MapeadorProcesoIngestionPartner())
        proceso_ingestion_partner.agregar_proceso_ingestion_partner(proceso_ingestion_partner)

        repositorio = self.fabrica_repositorio.crear_objeto(RepositorioProcesoIngestionPartnerPg.__class__)
