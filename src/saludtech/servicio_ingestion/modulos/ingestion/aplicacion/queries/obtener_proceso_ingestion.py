from saludtech.servicio_ingestion.seedwork.aplicacion.queries import Query, QueryHandler, QueryResultado
from saludtech.servicio_ingestion.seedwork.aplicacion.queries import ejecutar_query as query
