...
from saludtech.servicio_ingestion.modulos.partnership.infraestructura.schema.v1.eventos import EventoProcesoIngestionPartnerAgregado, ProcesoIngestionPartnerAgregadoPayload
from saludtech.servicio_ingestion.modulos.partnership.infraestructura.schema.v1.comandos import ComandoAgregarProcesoIngestionPartner, ComandoAgregarProcesoIngestionPartnerPayload
